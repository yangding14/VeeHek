...
function Settings_TermsAndCon(props) {
    return (
      ...
      >
        ...
        <Text style={{ flex: 1, textAlign: "center", fontFamily: fonts.RubikBold, fontSize: sh(20),paddingBottom:10}}>Terms and Condition</Text>
      </View>
      ...
      <ScrollView style ={{paddingHorizontal: sw(40)}}>
            ...
            <Text style={{fontFamily: fonts.Poppins, fontSize: sh(17),textAlign: 'justify',paddingTop: 20}}>In the modern world, managing debt can often feel like an uphill battle. The burden of debt not only limits financial opportunities but can also lead to significant stress, affecting one's ability to enjoy life to the fullest. Recognizing the urgency of this issue, Debty aims to simplify the debt management process, providing tools and resources that educate and empower individuals to regain control of their finances.</Text>
            ...
            <Text style={{fontFamily: fonts.Poppins, fontSize: sh(17),textAlign: 'justify',paddingTop: 20}}>By using our services, you agree to the following terms and conditions:</Text>
            <Text style={{fontFamily: fonts.Poppins, fontSize: sh(17),textAlign: 'justify',paddingTop: 20}}>1. You must be at least 18 years old to use our services.</Text>
            ...
            <Text style={{fontFamily: fonts.Poppins, fontSize: sh(17),textAlign: 'justify',paddingTop: 20}}>We reserve the right to terminate or suspend your account and access to our services if you violate any of the terms and conditions.</Text>
            <Text style={{fontFamily: fonts.Poppins, fontSize: sh(17),textAlign: 'justify',paddingTop: 20}}>We reserve the right to change the terms and conditions at any time without notice.</Text>
            <Text style={{fontFamily: fonts.Poppins, fontSize: sh(17),textAlign: 'justify',paddingTop: 20}}>If you have any questions about the terms and conditions, please contact us: </Text>    
            <Text style={{fontFamily: fonts.Poppins, fontSize: sh(17),paddingTop: 10, paddingBottom:150}}>By email: {'\t'}   
