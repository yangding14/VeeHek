...
function SetupExpensesCard({index, expenseName, expenseAmount, onPress}) {
            ...
            <TouchableWithoutFeedback onPress={onPress}>
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flex: 1}}>
                        <Text style={styles.textOperationName}>{expenseName}</Text>
                        <Text style={styles.textOperationDate}>{expenseAmount}</Text>
                    </View>
...
export default SetupExpensesCard;